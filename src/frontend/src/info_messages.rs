...
pub const GEMINI_SETTINGS_HEADING: &str = "Gemini";
...
pub const GEMINI_API_KEY_LABEL: &str = "Gemini API key";
pub const GEMINI_API_KEY_PLACEHOLDER: &str = "API key";
pub const GEMINI_API_KEY_TITLE: &str =
    "API key passed as the key query parameter to generativelanguage.googleapis.com.";
