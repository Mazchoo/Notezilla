...
- [ ] `update_note` tool creates a new `.md` file or updates an existing one with correct frontmatter.
- [ ] `delete_note` tool removes the file from disk and from the vector database.
